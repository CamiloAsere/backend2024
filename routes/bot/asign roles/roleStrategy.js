...
// Definir una clase DefaultRoleBalanceStrategy para manejar la lógica de crear balances de roles por defecto
class DefaultRoleBalanceStrategy {
  constructor() {
...
// Crear una instancia del DefaultRoleBalanceStrategy
const defaultStrategy = new DefaultRoleBalanceStrategy();

// Crear una instancia del RoleBalancer utilizando el DefaultRoleBalanceStrategy
const roleBalancer = new RoleBalancer(defaultStrategy);
